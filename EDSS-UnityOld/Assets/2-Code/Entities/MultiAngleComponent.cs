...
public class MultiAngleComponent : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float ang = Vector3.Angle(_entitySpriteObject._transform.forward,
            ClientGameManager.Singleton.playerControl._transform.position - _entitySpriteObject._transform.position);

        float angDir = Helpers.AngleDir(_entitySpriteObject._transform.forward,
            ClientGameManager.Singleton.playerControl._transform.position - _entitySpriteObject._transform.position, Vector3.up);
