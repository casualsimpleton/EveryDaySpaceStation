...
public class EDSSFirstPersonControls : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.E))
        {
            ...
            {
                ClientGameManager.Singleton.Client_AttemptInput(_edssCamera.CurrentHighlitedESGO);
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.R))
        {
            if (_edssCamera.CurrentHighlitedESGO != null)
            {
                ClientGameManager.Singleton.Client_AttemptAltInput(_edssCamera.CurrentHighlitedESGO);
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.Q))
        {
            if (_edssCamera.CurrentHighlitedESGO != null)
            {
                ClientGameManager.Singleton.Client_AttemptTertiaryInput(_edssCamera.CurrentHighlitedESGO);
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.L))
        {
            if (_edssCamera.CurrentHighlitedESGO != null)
            {
                ClientGameManager.Singleton.Client_AttempLockInput(_edssCamera.CurrentHighlitedESGO);
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.P))
        {
            if (_edssCamera.CurrentHighlitedESGO != null)
            {
                ClientGameManager.Singleton.Client_AttemptPowerInput(_edssCamera.CurrentHighlitedESGO);
            }
        }
    }
