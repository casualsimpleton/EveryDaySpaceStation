...
public class EntityBuildManager : MonoBehaviour
{
    ...
    public void AddEntityToBuildQueue(EntityData entity)
    {
    ...
    public void AddEntityToDeconstruction(EntityData entity)
    {
    ...
    private void BuildEntity(EntityData entity)
    {
    ...
    private void DeconstructEntity(EntityData entity)
    {
