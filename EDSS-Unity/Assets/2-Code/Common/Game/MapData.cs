    ...
    public class MapDataV2
    {
        ...
        public struct MapBlock
        {
            public struct BlockLightData
            {
                ...
                public static BlockLightData Copy(BlockLightData src)
                {
                    BlockLightData newdata = new BlockLightData();
                    newdata.Init();
                    newdata.color = src.color;
                    newdata.numLights = src.numLights;
                    newdata.colorR = src.colorR;
                    newdata.colorG = src.colorG;
                    newdata.colorB = src.colorB;
                ...
                {
                    color.r = (byte)(colorR / numLights);
                    color.g = (byte)(colorR / numLights);
                    color.b = (byte)(colorR / numLights);
            ...
            public byte DoesBlockLight { get; set; }
            public byte BlockPipe { get; set; }
            public BlockLightData BlockLight;
            ...
            public MapBlock(MapBlock blockToCopy)
            {
                ...
                DoesBlockLight = blockToCopy.DoesBlockLight;
                BlockPipe = blockToCopy.BlockPipe;
                BlockLight = BlockLightData.Copy(blockToCopy.BlockLight);
            }
